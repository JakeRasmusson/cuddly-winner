...
const Player = ({ player, handleIconClick, handleClick }) => {
    ...
    return (
        ...
        >
            ...
            <i 
                className="fa-solid fa-user-slash text-md absolute right-1 text-red-500 hover:text-red-700 hover:scale-130 transition-all duration:1000 hover:cursor-pointer p-1.5"
                onClick={e => {
                    e.stopPropagation()
                    handleIconClick()
                }}
